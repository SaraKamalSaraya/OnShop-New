...
interface StatusChangedLog extends LogBase {
  currentStatus?: string;
  previousStatus?: string;
  type: 'statusChanged';
}

interface ChangeCompleteLog extends LogBase {
  chargeId?: string;
  type: 'chargeComplete';
}

type Log = StatusChangedLog | ChangeCompleteLog;
...
const getContent = (log: Log): ReactNode => {
  switch (log.type) {
    case 'chargeComplete':
      return (
        <>
...
export const InvoicePaymentHistory: FC = () => (
  <Card>
