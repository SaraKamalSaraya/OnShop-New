...
const countryOptions: string[] = ['USA', 'Germany', 'Spain', 'Italy'];
...
const getInitialValues = (customer?: Customer): Values => {
  return {
...
export const CustomerDialog: FC<CustomerDialogProps> = (props) => {
  const {
    action = 'create',
    customer,
    open = false,
