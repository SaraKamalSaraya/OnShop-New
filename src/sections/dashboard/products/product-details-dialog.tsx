...
const compositionOptions: string[] = ['Leather', 'Metal', 'Plastic', 'Organic'];

const tagOptions: string[] = ['Watch', 'Style', 'New', 'Promo', 'Discount', 'Refurbished'];
...
const getInitialValues = (product?: Product): Values => {
  return {
    brand: product?.brand || '',
...
export const ProductDetailsDialog: FC<ProductDetailsDialogProps> = (props) => {
