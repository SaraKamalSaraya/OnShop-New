...
const statusMap: Record<ProductStatus, { color: string; label: string; }> = {
  draft: {
    color: 'info.main',
    label: 'Draft'
  },
...
const getResourcesState = (params: { isLoading: boolean; error?: string; items: Product[] }): ResourcesState => {
  if (params.isLoading) {
    return 'loading';
  }
...
interface ProductsTableProps {
  ...
  items?: Product[];
  onDeselectAll?: () => void;
  onDeselectOne?: (productId: string) => void;
