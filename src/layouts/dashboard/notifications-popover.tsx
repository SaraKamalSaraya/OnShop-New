...
interface CustomerNotification extends NotificationBase {
  type: 'newCustomer';
}

interface FeatureNotification extends NotificationBase {
  content?: string;
  title: string;
  type: 'newFeature';
}

type Notification = CustomerNotification | FeatureNotification;
